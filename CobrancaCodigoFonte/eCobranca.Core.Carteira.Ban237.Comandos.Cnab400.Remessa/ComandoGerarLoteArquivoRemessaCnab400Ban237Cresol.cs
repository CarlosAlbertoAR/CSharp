...
public class ComandoGerarLoteArquivoRemessaCnab400Ban237Cresol : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban237Cresol()
	{
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		foreach (DocumentoCobranca documento in base.Lote.Documentos)
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban237).GeraRegistroTransacaoTipo1)
			{
				...
				ComandoGerarTransacaoTipo1RemessaCnab400Ban237Cresol comandoGerarTransacaoTipo1RemessaCnab400Ban237Cresol = new ComandoGerarTransacaoTipo1RemessaCnab400Ban237Cresol();
				comandoGerarTransacaoTipo1RemessaCnab400Ban237Cresol.PrepararComando(carteira, segmento, documento);
				base.Comandos.Add(comandoGerarTransacaoTipo1RemessaCnab400Ban237Cresol);
			}
		}
	}
