...
public class ComandoGerarLoteArquivoRemessaCnab400Ban237 : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban237()
	{
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		foreach (DocumentoCobranca documento in base.Lote.Documentos)
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban237).GeraRegistroTransacaoTipo1)
			{
				...
				ComandoGerarTransacaoTipo1RemessaCnab400Ban237 comandoGerarTransacaoTipo1RemessaCnab400Ban = new ComandoGerarTransacaoTipo1RemessaCnab400Ban237();
			...
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban237).GeraRegistroTransacaoTipo2)
			{
				...
				ComandoGerarTransacaoTipo2RemessaCnab400Ban237 comandoGerarTransacaoTipo2RemessaCnab400Ban = new ComandoGerarTransacaoTipo2RemessaCnab400Ban237();
