...
public class ComandoGerarHeaderRemessaCnab400Ban237 : ComandoGerarSegmentoArquivoRemessaCnab400
{
	public ComandoGerarHeaderRemessaCnab400Ban237()
	{
	...
	public override void Execute()
	{
		try
		{
			...
			(base.Arquivo.Header as HeaderRemessaCnab400Ban237).CodigoBeneficiario.Valor = ((DadoConfiguracao)base.Carteira.DadosConfiguracao[2]).Valor;
			(base.Arquivo.Header as HeaderRemessaCnab400Ban237).NomeBeneficiario.Valor = base.Carteira.ConfiguracaoCarteiraCobranca.NomeBeneficiario;
