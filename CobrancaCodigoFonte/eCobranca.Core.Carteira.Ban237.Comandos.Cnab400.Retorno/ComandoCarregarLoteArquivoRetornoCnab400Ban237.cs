...
public class ComandoCarregarLoteArquivoRetornoCnab400Ban237 : ComandoCarregarLoteArquivoRetornoCnab400
{
	public ComandoCarregarLoteArquivoRetornoCnab400Ban237()
	{
		Logger.Debug($"Criando macro comando para carregar LOTE DE ARQUIVO de retorno CNAB400 do [{EnumCodigoBanco.BANCO_BRADESCO}]...");
		GerarComandos();
	}
	...
	public override void PrepararComando(CarteiraCobranca carteira, LoteCobrancaRetornoCnab400 lote)
	{
		...
		{
			if (item.Substring(0, 1).Equals(EnumTipoSegmentoDetalheCnab400Ban237.TRANSACAO_TIPO_1.Codigo()))
			{
				DetalheRetornoCnab400 segmento = new RegistroTransacaoTipo1RetornoCnab400Ban237();
				base.Lote.AdicionarSegmento(segmento);
				ComandoCarregarDetalheRetornoCnab400Ban237 comandoCarregarDetalheRetornoCnab400Ban = new ComandoCarregarDetalheRetornoCnab400Ban237();
