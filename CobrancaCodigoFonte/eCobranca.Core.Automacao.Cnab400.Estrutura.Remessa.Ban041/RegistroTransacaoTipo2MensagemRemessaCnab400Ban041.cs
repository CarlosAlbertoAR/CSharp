...
public class RegistroTransacaoTipo2MensagemRemessaCnab400Ban041 : DetalheRemessaCnab400, IRegistroTransacaoTipo2MensagemRemessaCnab400Ban041
{
	...
	public RegistroTransacaoTipo2MensagemRemessaCnab400Ban041(long sequenciaSegmento)
	...
	protected override void CarregarCampos()
	{
		try
		{
			...
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("02.1", "Tipo de inscrição beneficiário", "Tipo de inscrição beneficiário", EnumFormatoCampoLayoutArquivoCobranca.NUM, "0", "", 2, 3, 2, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("13.1", "ControleCanalMensagem 2", "ControleCanalMensagem 2", EnumFormatoCampoLayoutArquivoCobranca.NUM, "0", "", 202, 202, 1, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
