...
public class HeaderRemessaCnab400Ban756 : HeaderRemessaCnab400, IHeaderRemessaCnab400Ban756
{
	...
	public CampoLayoutArquivoCobranca ContaCorrenteBeneficiario => campos[8];

	public CampoLayoutArquivoCobranca DVContaBeneficiario => campos[9];

	public CampoLayoutArquivoCobranca NumeroConvenio => campos[10];
	...
	public CampoLayoutArquivoCobranca Filler2 => campos[15];

	public CampoLayoutArquivoCobranca NumeroSequencialRegistro => campos[16];

	public HeaderRemessaCnab400Ban756(long sequeciaSegmento)
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO HEADER de remessa CNAB400 do [{EnumCodigoBanco.BANCO_COOPERATIVO_DO_BRASIL}]...");
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("05.0", "Descrição tipo de serviço", "Identificação por extenso do tipo de serviço", EnumFormatoCampoLayoutArquivoCobranca.ALFA, "COBRANÇA", "", 12, 19, 8, 0, manterAcentuacao: true);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("11.0", "Número do convênio", "Número do convênio - Informar brancos.", EnumFormatoCampoLayoutArquivoCobranca.ALFA, "", "", 41, 46, 6, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("13.0", "Identificação do banco na compensação", "Identificação do banco na câmara de compensação", EnumFormatoCampoLayoutArquivoCobranca.ALFA, EnumCodigoBanco.BANCO_COOPERATIVO_DO_BRASIL.Codigo() + "BANCOOBCED", "", 77, 94, 18, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
