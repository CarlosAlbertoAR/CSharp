...
public class ComandoCarregarLoteArquivoRetornoCnab400Ban097 : ComandoCarregarLoteArquivoRetornoCnab400
{
	public ComandoCarregarLoteArquivoRetornoCnab400Ban097()
	{
	...
	public override void PrepararComando(CarteiraCobranca carteira, LoteCobrancaRetornoCnab400 lote)
	{
		...
		foreach (string item in base.Lote.LinhasLote)
		{
			...
			{
				DetalheRetornoCnab400 segmento = new DetalheRetornoCnab400Ban097();
				base.Lote.AdicionarSegmento(segmento);
				ComandoCarregarDetalheRetornoCnab400Ban097 comandoCarregarDetalheRetornoCnab400Ban = new ComandoCarregarDetalheRetornoCnab400Ban097();
