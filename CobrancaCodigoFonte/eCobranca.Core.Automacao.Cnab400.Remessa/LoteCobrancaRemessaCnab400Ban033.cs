...
public class LoteCobrancaRemessaCnab400Ban033 : LoteCobrancaRemessaCnab400
{
	private bool geraRegistroTipo1;

	public bool GeraRegistroTipo1 => geraRegistroTipo1;

	public LoteCobrancaRemessaCnab400Ban033()
	{
		try
		{
			Logger.Debug($"Criando lote de cobrança do arquivo de remessa CNAB400 do [{EnumCodigoBanco.BANCO_SANTANDER}]...");
		}
		catch (Exception ex)
		{
	...
	public override ArrayList CarregarRegistrosLote()
	{
		...
		try
		{
			...
			{
				if (segmento is RegistroTipo1RemessaCnab400Ban033 && GeraRegistroTipo1)
				{
	...
	public override void Preparar(ConfiguracaoArquivoRemessa configuracaoRemessa, ArrayList documentos, params bool[] parametros)
	{
		...
		if (parametros != null)
		{
			geraRegistroTipo1 = (base.ParameterUtil.GetValorParametroAdicional(EnumParametrosAdicionaisConfiguracao.REM_GERA_REGISTRO_TRANSACAO_TIPO_1_REMESSA_CNAB400, (base.Configuracao.ParametrosDisponiveis.Remessa as ParametrosAdicionaisDisponiveisConfiguracaoArquivoRemessaBan033).GeraRegistroTipo1RemessaCnab400(), base.Configuracao.ParametrosAdicionais).Equals("S") ? true : false);
		}
	}
}
