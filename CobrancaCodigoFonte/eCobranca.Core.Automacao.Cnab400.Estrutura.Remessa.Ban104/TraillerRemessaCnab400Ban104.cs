...
public class TraillerRemessaCnab400Ban104 : TraillerRemessaCnab400, ITraillerRemessaCnab400Ban104
{
	...
	public TraillerRemessaCnab400Ban104(long sequenciaSegmento, Guid guid)
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO TRAILLER de remessa CNAB400 do [{EnumCodigoBanco.CAIXA_ECONOMICA_FEDERAL}]...");
			...
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("02.9", "Uso exclusivo CAIXA", "Informar brancos", EnumFormatoCampoLayoutArquivoCobranca.ALFA, "", "", 2, 394, 393, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
