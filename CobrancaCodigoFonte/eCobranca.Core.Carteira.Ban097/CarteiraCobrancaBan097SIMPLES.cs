...
using eCobranca.Core.Carteira.Ban097.Comandos.Febraban240.Remessa;
using eCobranca.Core.Carteira.Ban097.Comandos.Febraban240.Retorno;
...
[Serializable]
public class CarteiraCobrancaBan097SIMPLES : CarteiraCobrancaBan097, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "1";

	public CarteiraCobrancaBan097SIMPLES(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan097SIMPLES(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override ConfiguracaoDocumentoCobranca CarregarConfiguracaoDocumentoCobranca()
	{
		...
		try
		{
			...
			result = new ConfiguracaoDocumentoCobranca(GetGuid(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO.ToString(), base.ModoUso, this, EnumTipoCarteiraCobranca.BAN097_SIMPLES);
			return result;
		}
		catch (Exception ex)
		{
	...
	protected override ConfiguracaoArquivoRemessa CarregarConfiguracaoArquivoRemessa()
	{
		...
		try
		{
			...
			configuracaoArquivoRemessa = new ConfiguracaoArquivoRemessa(GetGuid(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO.ToString(), base.ModoUso, this, 0, base.ConfiguracaoCarteiraCobranca.CobrancaRegistrada, EnumTipoCarteiraCobranca.BAN097_SIMPLES);
	...
	protected override ConfiguracaoArquivoRetorno CarregarConfiguracaoArquivoRetorno()
	{
		...
		try
		{
			...
			result = new ConfiguracaoArquivoRetorno(GetGuid(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO.ToString(), base.ModoUso, this, EnumTipoCarteiraCobranca.BAN097_SIMPLES);
			return result;
		}
		catch (Exception ex)
		{
	...
	{
		return (ArquivoCobrancaRemessaFebraban240)FactoryArquivoCobranca.CriarArquivoRemessa(GetGuid(), EnumLayoutArquivoRemessa.FEBRABAN240, (EnumTipoCarteiraCobranca)(object)base.ConfiguracaoCarteiraCobranca.TipoCarteiraCobranca.ToEnum<EnumTipoCarteiraCobranca>(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO);
	}

	protected override ArquivoCobrancaRemessaCnab400 CarregarArquivoRemessaCnab400()
	{
		return (ArquivoCobrancaRemessaCnab400Ban097CobrancaSimples)FactoryArquivoCobranca.CriarArquivoRemessa(GetGuid(), EnumLayoutArquivoRemessa.CNAB400, (EnumTipoCarteiraCobranca)(object)base.ConfiguracaoCarteiraCobranca.TipoCarteiraCobranca.ToEnum<EnumTipoCarteiraCobranca>(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO);
	}

	protected override MacroCommand CarregarComandoGerarRemessaFebraban240()
	{
		return new ComandoGerarArquivoRemessaFebraban240Ban097(this);
	}

	protected override MacroCommand CarregarComandoGerarRemessaCnab400()
	{
		return new ComandoGerarArquivoRemessaCnab400Ban097CobrancaSimples();
	}

	protected override ArquivoCobrancaRetornoFebraban240 CarregarArquivoRetornoFebraban240()
	{
		return (ArquivoCobrancaRetornoFebraban240)FactoryArquivoCobranca.CriarArquivoRetorno(GetGuid(), EnumLayoutArquivoRetorno.FEBRABAN240, (EnumTipoCarteiraCobranca)(object)base.ConfiguracaoCarteiraCobranca.TipoCarteiraCobranca.ToEnum<EnumTipoCarteiraCobranca>(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO);
	}

	protected override ArquivoCobrancaRetornoCnab400 CarregarArquivoRetornoCnab400()
	{
		return (ArquivoCobrancaRetornoCnab400Ban097CobrancaSimples)FactoryArquivoCobranca.CriarArquivoRetorno(GetGuid(), EnumLayoutArquivoRetorno.CNAB400, (EnumTipoCarteiraCobranca)(object)base.ConfiguracaoCarteiraCobranca.TipoCarteiraCobranca.ToEnum<EnumTipoCarteiraCobranca>(), EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO);
	}
	...
	{
		return new ComandoCarregarArquivoRetornoFebraban240Ban097(this);
	}

	protected override MacroCommand CarregarComandoProcessarRetornoCnab400()
	{
		return new ComandoCarregarArquivoRetornoCnab400Ban097CobrancaSimples();
	}
	...
	protected override string GerarArquivoRemessaFebraban240(ArrayList dcList)
	{
		...
		try
		{
			...
			{
				Logger.Debug($"Gerando arquivo de remessa FEBRABAN240 para o [{EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO}]...");
				remessaFebraban240.Preparar(this);
				remessaFebraban240.NovoLote(dcList);
				(comandoGerarRemessaFebraban240 as ComandoGerarArquivoRemessaFebraban240Ban097).Preparar(this, remessaFebraban240);
	...
	protected override string GerarArquivoRemessaCNAB400(ArrayList dcList)
	{
		...
		try
		{
			...
			(comandoGerarRemessaCnab400 as ComandoGerarArquivoRemessaCnab400Ban097CobrancaSimples).Preparar(this, remessaCnab400);
	...
	protected override ArrayList CarregarArquivoRetornoFebraban240(string nomeArquivoRetorno)
	{
		...
		try
		{
			Logger.Debug($"Processando arquivo de retorno FEBRABAN240 do [{EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO}]...)");
			retornoFebraban240.Preparar(this, base.ConfiguracaoArquivoRetorno.DiretorioArquivoRetorno, nomeArquivoRetorno);
			(comandoProcessarRetornoFebraban240 as ComandoCarregarArquivoRetornoFebraban240Ban097).Preparar(this, retornoFebraban240);
	...
	protected override ArrayList CarregarArquivoRetornoCnab400(string nomeArquivoRetorno)
	{
		...
		try
		{
			...
			(comandoProcessarRetornoCnab400 as ComandoCarregarArquivoRetornoCnab400Ban097CobrancaSimples).Preparar(this, retornoCnab400);
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		base.DadosConfiguracao.Add(value);
		value = new DadoConfiguracao("CodigoCooperado", "Código do cooperado no CREDISISCOBRANCA", "Código do cooperado", "000000");
		base.DadosConfiguracao.Add(value);
	...
	protected override string GetNossoNumeroSemDV(DocumentoCobranca dc)
	{
		...
		try
		{
			...
			string text = "097";
			string dVModulo11Ban = DVGenerator.GetDVModulo11Ban097(StringUtil.RemoverMascara(base.ConfiguracaoCarteiraCobranca.NumeroInscricaoBeneficiario));
			string valor4 = ((DadoConfiguracao)base.DadosConfiguracao[0]).Valor;
			string valor5 = ((DadoConfiguracao)base.DadosConfiguracao[2]).Valor;
			result = text + dVModulo11Ban + valor4 + valor5 + valor;
			return result;
		}
		catch (Exception ex)
		{
