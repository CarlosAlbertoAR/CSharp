...
[Serializable]
public class CarteiraCobrancaBan748CodigoC : CarteiraCobrancaBan748, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "3";

	public CarteiraCobrancaBan748CodigoC(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan748CodigoC(SerializationInfo serobj, StreamingContext scontext)
