...
public class ComandoCarregarLoteArquivoRetornoCnab400Ban033 : ComandoCarregarLoteArquivoRetornoCnab400
{
	public ComandoCarregarLoteArquivoRetornoCnab400Ban033()
	{
		Logger.Debug($"Criando macro comando para carregar LOTE DE ARQUIVO de retorno CNAB400 do [{EnumCodigoBanco.BANCO_SANTANDER}]...");
		GerarComandos();
	}
	...
	public override void PrepararComando(CarteiraCobranca carteira, LoteCobrancaRetornoCnab400 lote)
	{
		...
		{
			if (item.Substring(0, 1).Equals(EnumTipoSegmentoDetalheCnab400Ban033.REGISTRO_TIPO_1.Codigo()))
			{
				DetalheRetornoCnab400 segmento = new RegistroTipo1RetornoCnab400Ban033();
				base.Lote.AdicionarSegmento(segmento);
				ComandoCarregarDetalheRetornoCnab400Ban033 comandoCarregarDetalheRetornoCnab400Ban = new ComandoCarregarDetalheRetornoCnab400Ban033();
