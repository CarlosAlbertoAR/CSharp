...
public class RegistroTransacaoTipo2RemessaCnab400Ban237 : SegmentoLoteCnab400, IRegistroTransacaoTipo2RemessaCnab400Ban237
{
	...
	public RegistroTransacaoTipo2RemessaCnab400Ban237(long sequenciaSegmento)
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO TRANSAÇÃO TIPO 2 de remessa CNAB400 do [{EnumCodigoBanco.BANCO_BRADESCO}]...");
			...
			campoLayoutArquivoCobranca.Preparar("01.2", "Tipo de registro", "Informar 2", EnumFormatoCampoLayoutArquivoCobranca.NUM, EnumTipoSegmentoDetalheCnab400Ban237.TRANSACAO_TIPO_2.Codigo(), "", 1, 1, 1, 0);
