...
public class ComandoGerarLoteArquivoRemessaCnab400Ban422 : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban422()
	{
		Logger.Debug($"Criando macro comando para gerar LOTE DE ARQUIVO de remessa CNAB400 do [{EnumCodigoBanco.BANCO_SAFRA}]...");
		GerarComandos();
	}
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban422).GeraRegistroTransacaoTipo1)
			{
				SegmentoCnab400 segmento = new RegistroTransacaoTipo1RemessaCnab400Ban422(0L);
				segmento = base.Lote.AdicionarSegmento(segmento);
				ComandoGerarTransacaoTipo1RemessaCnab400Ban422 comandoGerarTransacaoTipo1RemessaCnab400Ban = new ComandoGerarTransacaoTipo1RemessaCnab400Ban422();
			...
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban422).GeraRegistroTransacaoTipo2)
			{
				SegmentoCnab400 segmento2 = new RegistroTransacaoTipo2RemessaCnab400Ban422(0L);
				segmento2 = base.Lote.AdicionarSegmento(segmento2);
				ComandoGerarTransacaoTipo2RemessaCnab400Ban422 comandoGerarTransacaoTipo2RemessaCnab400Ban = new ComandoGerarTransacaoTipo2RemessaCnab400Ban422();
