...
public class ComandoCarregarLoteArquivoRetornoCnab400Ban422 : ComandoCarregarLoteArquivoRetornoCnab400
{
	public ComandoCarregarLoteArquivoRetornoCnab400Ban422()
	{
		Logger.Debug($"Criando macro comando para carregar LOTE DE ARQUIVO de retorno CNAB400 do [{EnumCodigoBanco.BANCO_SAFRA}]...");
		GerarComandos();
	}
	...
	public override void PrepararComando(CarteiraCobranca carteira, LoteCobrancaRetornoCnab400 lote)
	{
		...
		{
			if (item.Substring(0, 1).Equals(EnumTipoSegmentoDetalheCnab400Ban422.TRANSACAO_TIPO_1.Codigo()))
			{
				DetalheRetornoCnab400 segmento = new RegistroTransacaoTipo1RetornoCnab400Ban422();
				base.Lote.AdicionarSegmento(segmento);
				ComandoCarregarDetalheRetornoCnab400Ban422 comandoCarregarDetalheRetornoCnab400Ban = new ComandoCarregarDetalheRetornoCnab400Ban422();
