...
public class ComandoGerarLoteArquivoRemessaCnab400Ban004 : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban004()
	{
		Logger.Debug($"Criando macro comando para gerar LOTE DE ARQUIVO de remessa CNAB400 do [{EnumCodigoBanco.BANCO_DO_NORDESTE_DO_BRASIL}]...");
		GerarComandos();
	}
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban004).GeraSegmentoDetalhe)
			{
				SegmentoCnab400 segmento = new DetalheRemessaCnab400Ban004(0L);
				segmento = base.Lote.AdicionarSegmento(segmento);
				ComandoGerarDetalheRemessaCnab400Ban004 comandoGerarDetalheRemessaCnab400Ban = new ComandoGerarDetalheRemessaCnab400Ban004();
