...
[Serializable]
public class CarteiraCobrancaBan033CodigoECR_NOVA_240 : CarteiraCobrancaBan033Nova, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "ECR";

	public CarteiraCobrancaBan033CodigoECR_NOVA_240(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
	...
	public CarteiraCobrancaBan033CodigoECR_NOVA_240(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		base.DadosConfiguracao.Add(value);
		value = new DadoConfiguracao("Modalidade", "Modalidade de cobranca", "Modalidade de cobrança", "0", EnumUtil.GetEnumByAttributeToItemLista<EnumModalidadeCarteiraCobranca, AtributoChave>(new AtributoChave(EnumTipoCarteiraCobranca.BAN033_ECR_NOVA_240, EnumCodigoBanco.BANCO_SANTANDER)));
		base.DadosConfiguracao.Add(value);
