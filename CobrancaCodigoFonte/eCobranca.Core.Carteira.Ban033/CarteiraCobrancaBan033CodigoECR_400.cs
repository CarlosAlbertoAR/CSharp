...
[Serializable]
public class CarteiraCobrancaBan033CodigoECR_400 : CarteiraCobrancaBan033Antiga, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "ECR";

	public CarteiraCobrancaBan033CodigoECR_400(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
	...
	public CarteiraCobrancaBan033CodigoECR_400(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		DadoConfiguracao value = new DadoConfiguracao("Modalidade", "Modalidade de cobranca", "Modalidade de cobrança", "0", EnumUtil.GetEnumByAttributeToItemLista<EnumModalidadeCarteiraCobranca, AtributoChave>(new AtributoChave(EnumTipoCarteiraCobranca.BAN033_ECR_400, EnumCodigoBanco.BANCO_SANTANDER)));
