...
[Serializable]
public class CarteiraCobrancaBan033CodigoCSR : CarteiraCobrancaBan033Antiga, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "CSR";

	public CarteiraCobrancaBan033CodigoCSR(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
	...
	public CarteiraCobrancaBan033CodigoCSR(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		DadoConfiguracao value = new DadoConfiguracao("Modalidade", "Modalidade de cobranca", "Modalidade de cobrança", "0", EnumUtil.GetEnumByAttributeToItemLista<EnumModalidadeCarteiraCobranca, AtributoChave>(new AtributoChave(EnumTipoCarteiraCobranca.BAN033_CSR_NOVA, EnumCodigoBanco.BANCO_SANTANDER)));
