...
[Serializable]
public class CarteiraCobrancaBan033CodigoRCR_NOVA_400 : CarteiraCobrancaBan033Nova, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "RCR";

	public CarteiraCobrancaBan033CodigoRCR_NOVA_400(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
	...
	public CarteiraCobrancaBan033CodigoRCR_NOVA_400(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		base.DadosConfiguracao.Add(value);
		value = new DadoConfiguracao("Modalidade", "Modalidade de cobranca", "Modalidade de cobrança", "0", EnumUtil.GetEnumByAttributeToItemLista<EnumModalidadeCarteiraCobranca, AtributoChave>(new AtributoChave(EnumTipoCarteiraCobranca.BAN033_RCR_NOVA_400, EnumCodigoBanco.BANCO_SANTANDER)));
		base.DadosConfiguracao.Add(value);
