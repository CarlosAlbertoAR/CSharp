...
public static class FactorySegmentoDetalheCnab400Ban136
{
	public static SegmentoCnab400 NovoSegmentoDetalheRemessa(EnumTipoSegmentoDetalheCnab400Ban136 tipoSegmento, long sequenciaSegmento)
	{
		...
		try
		{
			...
			switch (tipoSegmento)
			{
			case EnumTipoSegmentoDetalheCnab400Ban136.REGISTRO_TIPO1:
				result = new RegistroTipo1RemesaCnab400Ban136(sequenciaSegmento);
				return result;
			case EnumTipoSegmentoDetalheCnab400Ban136.REGISTRO_TIPO5:
				result = new RegistroTipo5RemesaCnab400Ban136(sequenciaSegmento);
				return result;
			default:
				return result;
			}
	...
	public static DetalheRetornoCnab400 NovoSegmentoDetalheRetorno(EnumTipoSegmentoDetalheCnab400Ban136 tipoSegmento)
	{
		...
		try
		{
			...
			if (tipoSegmento == EnumTipoSegmentoDetalheCnab400Ban136.REGISTRO_TIPO1)
			{
				result = new RegistroTipo1RetornoCnab400Ban136();
				return result;
			}
			return result;
		}
