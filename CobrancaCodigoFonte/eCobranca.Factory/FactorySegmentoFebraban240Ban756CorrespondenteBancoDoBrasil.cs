...
public class FactorySegmentoFebraban240Ban756CorrespondenteBancoDoBrasil : FactorySegmentoFebraban240
{
	public override SegmentoFebraban240 NovoSegmento(EnumTipoSegmentoFebraban240 tipoSegmento, long sequenciaLote, long sequenciaSegmento, bool segmentoDeRemessa)
	{
		...
		try
		{
			...
			case EnumTipoSegmentoFebraban240.HEADER_LOTE:
				segmentoFebraban = new HeaderLoteFebraban240Ban756CorrespondenteBancoBrasil();
				return segmentoFebraban;
			case EnumTipoSegmentoFebraban240.SEGMENTO_P:
				segmentoFebraban = new SegmentoDetalhePFebraban240Ban756CorrespondenteBancoBrasil(0L, 0L);
			...
			case EnumTipoSegmentoFebraban240.SEGMENTO_Q:
				segmentoFebraban = new SegmentoDetalheQFebraban240Ban756CorrespondenteBancoBrasil(0L, 0L);
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaLote = sequenciaLote;
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaSegmento = sequenciaSegmento;
				return segmentoFebraban;
			...
			case EnumTipoSegmentoFebraban240.SEGMENTO_T:
				segmentoFebraban = new SegmentoDetalheTFebraban240Ban756CorrespondenteBancoBrasil(0L, 0L);
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaLote = sequenciaLote;
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaSegmento = sequenciaSegmento;
				return segmentoFebraban;
			case EnumTipoSegmentoFebraban240.SEGMENTO_U:
				segmentoFebraban = new SegmentoDetalheUFebraban240Ban756CorrespondenteBancoBrasil(0L, 0L);
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaLote = sequenciaLote;
				(segmentoFebraban as SegmentoDetalheFebraban240).SequenciaSegmento = sequenciaSegmento;
				return segmentoFebraban;
			case EnumTipoSegmentoFebraban240.TRAILLER_LOTE:
				segmentoFebraban = new TraillerLoteFebraban240Ban756CorrespondenteBancoBrasil();
				return segmentoFebraban;
			case EnumTipoSegmentoFebraban240.TRAILLER_ARQUIVO:
				segmentoFebraban = new TraillerArquivoFebraban240Padrao();
				return segmentoFebraban;
			default:
				return segmentoFebraban;
