...
public static class FactorySegmentoDetalheCnab400Ban399
{
	public static SegmentoCnab400 NovoSegmentoDetalheRemessa(EnumTipoSegmentoDetalheCnab400Ban399 tipoSegmento, long sequenciaSegmento)
	{
		...
		try
		{
			...
			if (tipoSegmento == EnumTipoSegmentoDetalheCnab400Ban399.REGISTRO_TIPO_1)
			{
				result = new DetalheRemessaCnab400Ban399(sequenciaSegmento);
				return result;
			}
			return result;
		}
	...
	public static DetalheRetornoCnab400 NovoSegmentoDetalheRetorno(EnumTipoSegmentoDetalheCnab400Ban399 tipoSegmento)
	{
		...
		try
		{
			...
			if (tipoSegmento == EnumTipoSegmentoDetalheCnab400Ban399.REGISTRO_TIPO_1)
			{
				result = new DetalheRetornoCnab400Ban399();
				return result;
			}
			return result;
		}
