...
public class ComandoGerarLoteArquivoRemessaCnab400Ban399 : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban399()
	{
		Logger.Debug($"Criando macro comando para gerar LOTE DE ARQUIVO de remessa CNAB400 do [{EnumCodigoBanco.HSBC_BANK_BRASIL}]...");
	}
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban399).GeraRegistroTipo1)
			{
				SegmentoCnab400 segmento = new DetalheRemessaCnab400Ban399(0L);
				segmento = base.Lote.AdicionarSegmento(segmento);
				ComandoGerarRegistroDetalheTipo1RemessaCnab400Ban399 comandoGerarRegistroDetalheTipo1RemessaCnab400Ban = new ComandoGerarRegistroDetalheTipo1RemessaCnab400Ban399();
				comandoGerarRegistroDetalheTipo1RemessaCnab400Ban.PrepararComando(carteira, segmento, documento);
				base.Comandos.Add(comandoGerarRegistroDetalheTipo1RemessaCnab400Ban);
			}
		}
	}
