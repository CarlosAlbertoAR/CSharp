...
public class ComandoGerarLoteArquivoRemessaCnab400Ban021 : ComandoGerarLoteArquivoRemessaCnab400, IObservable
{
	public event EventHandler<NotifyEvent> onNotifyEvent;

	public ComandoGerarLoteArquivoRemessaCnab400Ban021()
	{
		Logger.Debug($"Criando macro comando para gerar LOTE DE ARQUIVO de remessa CNAB400 do [{EnumCodigoBanco.BANCO_DO_ESTADO_DO_ESPIRITO_SANTO}]...");
		GerarComandos();
	}
	...
	public override void Preparar(CarteiraCobranca carteira, LoteCobrancaRemessaCnab400 lote)
	{
		...
		{
			if ((base.Lote as LoteCobrancaRemessaCnab400Ban021).GeraRegistroTransacao)
			{
				SegmentoCnab400 segmento = new RegistroTransacaoRemessaCnab400Ban021(0L);
				segmento = base.Lote.AdicionarSegmento(segmento);
				ComandoGerarTransacaoRemessaCnab400Ban021 comandoGerarTransacaoRemessaCnab400Ban = new ComandoGerarTransacaoRemessaCnab400Ban021();
				comandoGerarTransacaoRemessaCnab400Ban.PrepararComando(carteira, segmento, documento);
				base.Comandos.Add(comandoGerarTransacaoRemessaCnab400Ban);
			}
		}
	}
