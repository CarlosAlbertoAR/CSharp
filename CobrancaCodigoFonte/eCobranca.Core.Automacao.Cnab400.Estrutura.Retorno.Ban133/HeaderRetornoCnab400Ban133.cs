...
public class HeaderRetornoCnab400Ban133 : HeaderRetornoCnab400, IHeaderRetornoCnab400Ban133
{
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO HEADER de retorno CNAB400 do [{EnumCodigoBanco.CRESOL}]...");
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("08.0", "Código do banco bradesco", "Informar 237", EnumFormatoCampoLayoutArquivoCobranca.NUM, EnumCodigoBanco.CRESOL.Codigo(), "", 77, 79, 3, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
