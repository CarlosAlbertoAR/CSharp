...
public class HeaderRemessaCnab400Ban084 : HeaderRemessaCnab400, IHeaderRemessaCnab400Ban084
{
	...
	public HeaderRemessaCnab400Ban084(long sequeciaSegmento)
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO HEADER de remessa CNAB400 do [{EnumCodigoBanco.UNIPRIME_NORTE_PARANA}]...");
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("08.0", "Código do banco", "Número do bradesco na câmara de compensação", EnumFormatoCampoLayoutArquivoCobranca.NUM, EnumCodigoBanco.UNIPRIME_NORTE_PARANA.Codigo(), "", 77, 79, 3, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("09.0", "Nome do banco por extenso", "Nome do banco por extenso", EnumFormatoCampoLayoutArquivoCobranca.ALFA, EnumCodigoBanco.UNIPRIME_NORTE_PARANA.Sigla(), "", 80, 94, 15, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
