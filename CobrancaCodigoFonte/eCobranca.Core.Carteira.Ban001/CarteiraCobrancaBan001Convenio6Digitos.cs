...
[Serializable]
public abstract class CarteiraCobrancaBan001Convenio6Digitos : CarteiraCobrancaBan001, ISerializable
{
	public CarteiraCobrancaBan001Convenio6Digitos(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan001Convenio6Digitos(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		base.DadosConfiguracao.Add(value);
		value = new DadoConfiguracao("CodigoCedente", "Número do código do convênio", "Código do convênio", "000000");
		base.DadosConfiguracao.Add(value);
