...
[Serializable]
public abstract class CarteiraCobrancaBan001Convenio7Digitos : CarteiraCobrancaBan001, ISerializable
{
	public CarteiraCobrancaBan001Convenio7Digitos(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan001Convenio7Digitos(SerializationInfo serobj, StreamingContext scontext)
	...
	protected override void CarregarDadosConfiguracao()
	{
		...
		base.DadosConfiguracao.Add(value);
		value = new DadoConfiguracao("CodigoCedente", "Número do código do convênio", "Código do convênio", "0000000");
		base.DadosConfiguracao.Add(value);
	...
	protected override string GetCampoLivre(DocumentoCobranca dc)
	{
		...
		try
		{
			...
			result = "000000" + dc.NossoNumero + base.ConfiguracaoCarteiraCobranca.CodigoCarteiraCobranca;
			return result;
		}
		catch (Exception ex)
		{
