...
public class HeaderRetornoCnab400Ban097CobrancaSimples : HeaderRetornoCnab400, IHeaderRetornoCnab400Ban097CobrancaSimples
{
	...
	protected override void CarregarCampos()
	{
		try
		{
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("16.0", "Versão do arquivo", "Informar 001.", EnumFormatoCampoLayoutArquivoCobranca.ALFA, "", "", 392, 394, 3, 0);
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
