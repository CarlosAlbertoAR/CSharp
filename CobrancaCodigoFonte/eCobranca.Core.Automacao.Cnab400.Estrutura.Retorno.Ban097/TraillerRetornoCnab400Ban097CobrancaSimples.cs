...
public class TraillerRetornoCnab400Ban097CobrancaSimples : TraillerRetornoCnab400, ITraillerRetornoCnab400Ban097CobrancaSimples
{
	...
	protected override void CarregarCampos()
	{
		try
		{
			...
			campos.Add(campoLayoutArquivoCobranca);
			campoLayoutArquivoCobranca = new CampoLayoutArquivoCobranca();
			campoLayoutArquivoCobranca.Preparar("03.9", "Sequencial do registro", "Sequencial do registro", EnumFormatoCampoLayoutArquivoCobranca.NUM, "0", "", 395, 400, 6, 0);
			campos.Add(campoLayoutArquivoCobranca);
		}
		catch (Exception ex)
		{
