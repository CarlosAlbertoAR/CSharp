...
public class TraillerRemessaCnab400Ban097 : TraillerRemessaCnab400, ITraillerRemessaCnab400Ban097
{
	...
	public TraillerRemessaCnab400Ban097(long sequeciaSegmento, Guid guid)
	...
	protected override void CarregarCampos()
	{
		try
		{
			Logger.Debug($"Criando campos do REGISTRO DE TRAILLER de remessa CNAB400 do [{EnumCodigoBanco.COOPERATIVA_CENTRAL_DE_CREDITO_NOROESTE_BRASILEIRO}]...");
