...
[Serializable]
public class CarteiraCobrancaBan004Codigo541 : CarteiraCobrancaBan004, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "541";

	public CarteiraCobrancaBan004Codigo541(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan004Codigo541(SerializationInfo serobj, StreamingContext scontext)
