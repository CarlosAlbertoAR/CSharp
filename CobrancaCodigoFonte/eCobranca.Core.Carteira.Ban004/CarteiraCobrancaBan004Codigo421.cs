...
[Serializable]
public class CarteiraCobrancaBan004Codigo421 : CarteiraCobrancaBan004, ISerializable
{
	public const string CODIGO_CARTEIRA_IMPRESSAO = "421";

	public CarteiraCobrancaBan004Codigo421(ConfiguracaoCarteiraCobranca configuracaoCarteiraCobranca)
		: base(configuracaoCarteiraCobranca)
	{
	}

	public CarteiraCobrancaBan004Codigo421(SerializationInfo serobj, StreamingContext scontext)
